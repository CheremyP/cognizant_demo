...
import AudioUploadInterface from './ChatAudio';
...
const ChatInterfaceComponent: React.FC<ChatInterfaceComponentProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2">
      {/*Chat Messages*/}
      <div className="flex flex-col bg-bg-alt-verba rounded-lg shadow-lg p-2 md:p-5 text-text-verba gap-5  h-[51vh] overflow-auto">

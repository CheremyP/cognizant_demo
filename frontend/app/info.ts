...
export const chat_interface_info =
  "Use the Audio Interface to interact with your data. Your audio transcripts will be used to retrieve relevant information and to construct a response. You can choose between different Large Language Models (LLM) to create a response.";
